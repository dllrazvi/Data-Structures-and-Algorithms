...
class SkipList
{
	...
	int MAX;  // Maximum level for this skip list; -> skip pointers  0..MAX
...
void SkipList::insertElement(TComp key)
{
    ...
    if (rlevel>levels) levels=rlevel;
};
